...
export const HAIR_COLOURS = ['#303333','#684735','#ac7845','#d2bd82','#c1bbb4','#72618e'] as const;
export interface CharacterAppearance { sex:'male'|'female'; hairStyle:TeacherLook['hairStyle']; skin:string; hair:string }
export const defaultAppearance = (): CharacterAppearance => ({sex:'male',hairStyle:'swept',skin:SKIN_COLOURS[1],hair:HAIR_COLOURS[0]});
